...
Our work makes three significant contributions. Firstly, the use of automated symbolic verification in PV systems was uncommon in recent prior studies~\cite{TrindadeCordeiro19}, and specifically, their use in synthesizing PV sizing is unprecedented. Secondly, we evaluate different state-of-art symbolic software verifiers to obtain the best performance in our verification back-end for synthesizing optimal PV systems. Lastly, we discuss the main challenges of applying model checking to a real-world PV setting and also reflect on lessons learned from this practical experience.
