...
(g) it was included a generic flat-plate PV of $1$ kW and generic lead-acid batteries of $1$ kW (and with capacity of $83.4$ Ah according to HOMER Pro modeling). During run-time, HOMER decides the size in kW of each module based on feasibility and lower cost.
