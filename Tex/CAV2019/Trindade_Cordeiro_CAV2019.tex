...
ESBMC and ESBMC Incremental indicated that the $1,200$W system (House 5) has sizing error related to the \textcolor{red}{right?} number of solar panels. Related to the 700W systems (Houses 1-4), ESBMC and ESBMC incremental indicated that there is a situation of low state of charge from batteries that will cause the cut of the load, just after the 16:00h of the day, when the weather condition was not enough to charge the batteries.
