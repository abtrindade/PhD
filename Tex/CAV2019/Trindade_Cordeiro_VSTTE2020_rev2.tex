...
\textcolor{blue}{Summarizing: Our proposal is a technique based on CEGIS and we aim to synthesize the optimal solution of a PV system. Therefore, our technique produces an optimization.}
