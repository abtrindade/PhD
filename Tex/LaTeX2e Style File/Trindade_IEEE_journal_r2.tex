...
The main challenge here is to demonstrate the use of automated software model checking in stand-alone PV solution, thus proving that this evaluation is more effective and complete than other state-of-the-art tool such as HOMER Pro. The comparative evaluation between the HOMER Pro and the proposed verification tool is presented in Section~\ref{sec:results_indeed}.
