...
Here, the model adopted~\cite{Copetti} uses only manufacturer's data, without the need of empirical tests. % and allows finding relations among voltage, current, state of charge and temperature. 
%
