...
ESBMC comes as an alternative to overcome limitations of the systems modeling, especially considering that the complexity of these is increasing and the SMT method has high level and richer theories than the SAT to represent the models \cite{esbmc2018}. 
...
The feature called k-induction at Fig. \ref{fig:esbmcarch} allows BMC to find a property violation or even to prove (partial) correctness without fully unwinding loops. 
%
