...
And related to the four 700 W PV system, the sizing check was successful, but there were  found flaws in everyone, all related with the SOC that reached levels below of 75\%. The automated verification identified the flaws right after the first night-discharge cycle, before dawn, and before the system start to recharge the batteries. The proposed tool took 409.3 hours to find an error at house 1, and the maximum of 456XXX hours to house 4.  
