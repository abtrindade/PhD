...
\centering
\caption{Flowchart of the proposed automated verification of PV systems. \textcolor{red}{replace ``show fail detail'' by ``show counterexample''. replace ``non deterministic test of variables'' by ``non-deterministic variables''. replace ``Project OK'' by ``Project meets the specification up to the given bound''.}}
