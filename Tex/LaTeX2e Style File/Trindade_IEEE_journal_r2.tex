...
is usually studied using an equivalent circuit model~\cite{Yatimi,Saloux,Mellit}; this equivalent circuit consists of a current source with one or two diodes connected in parallel, and up to two resistors, one connected in parallel and the other one in series, in order to take into account energy losses in this model~\cite{Cubas}. 
