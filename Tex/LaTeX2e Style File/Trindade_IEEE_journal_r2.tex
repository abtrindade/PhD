...
the configuration that is most common is the regulated stand-alone system with battery and AC load. This configuration is the focus of this paper.
...
%-------------------------------------------------------------------
%
Considering the focus of this paper, only HOMER remains for a comparative with the proposed tool of this paper. %All tools need some parameters inherently from manufacturer's catalog.
...
And the challenge of this work is to prove that is possible to use automated verification in stand-alone PV solution and to prove that this evaluation is more efficient and complete than other state-of-the-art tool, as HOMER Pro. The comparative evaluation between the HOMER Pro and the proposed verification tool is presented in Section \ref{sec:results}.
