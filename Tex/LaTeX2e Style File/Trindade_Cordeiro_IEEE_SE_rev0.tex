...
\thanks{The authors would like to thank Newton Fund (ref. 261881580) and FAPEAM (Amazonas State Foundation for Research Support, call 009/2017 and PROTI Pesquisa 2018), for the financial support.}
\thanks{Manuscript received January 23, 2019; revised XXXXX 11, 2019.}}
...
% The paper headers
\markboth{IEEE Transactions on Software Engineering,~Vol.~XX, No.~YY, August~2019}%
{Trindade and Cordeiro: Automated Verification of Stand-Alone Solar Photovoltaic Systems}
...
\centering
\caption{HOMER simulation screen (evaluation 30-days version).}
