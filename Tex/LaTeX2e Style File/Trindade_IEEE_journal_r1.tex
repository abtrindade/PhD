...
However, related to the results of the automated verification, the 1,200 W PV system failed during the sizing check. The number of panels in series was not the correct (the verification indicates 3 panels in series and the project has 2 in series and 2 in parallel). That verification took 3 days to be performed. Surveying the owner of the 1,200 W system it was identified that, in fact, the system mostly of the time do not met the battery autonomy (mainly when all the loads are turned on).

And related to the four 700 W PV system, the sizing check was successful, but all the fail occurred during battery autonomy verification. XXXXXXX
