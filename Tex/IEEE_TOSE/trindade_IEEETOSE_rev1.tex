...
\begin{figure}[h]
%\hspace*{-1cm} 
\includegraphics[width=0.5\textwidth]{optimalsizingprocess4}
\centering
...
%	\includegraphics[width=0.75\columnwidth]{fig2_rev2.jpg}
	\hspace*{-1cm}\includegraphics[width=0.55\textwidth]{fig2_rev2.jpg}
