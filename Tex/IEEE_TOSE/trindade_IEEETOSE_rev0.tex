...
\item We propose a variant CEGIS method that consists of four distinct differences related to the traditional CEGIS: \textcolor{red}{explain here}
\item Experimental results show that our proposed formal synthesis approach outperforms an existing state-of-the-art simulation tool used in a comparative with seven case studies. The median runtime for our case studies is X\,s, \textcolor{red}{is it good or bad? try to emphasize our main achievements gere}.
\end{itemize}
