...
%CPAchecker algorithms can traverse a finite state machine for a fixed number of steps, $k$, and checks whether violation occurs with this bound; therefore is not necessary to search for 
%
%BMC techniques are only able to falsify properties up to the given depth k;
%
