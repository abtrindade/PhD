...
\subsection{Variant CEGIS} 
Related to the CEGIS presented in chapter Background, it was created a variant CEGIS method at this work. There are four particular differences related to the traditional CEGIS: 
...
\section{Assumptions and Premises}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
