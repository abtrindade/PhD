...
% ~\nameref or \autoref{
Chapter \nameref{chap:background} gives the theoretical basis on formal methods, formal verification, automated verification, solar PV systems, design and validation of PV systems, program synthesis, and the mathematical modeling. Chapter~\nameref{chap:methodology1} presents the automated verification technique, and chapter~\nameref{chap:methodology2} presents the automated synthesis technique from computer science. The results related to the experimental use of automated verification are in \autoref{chap:automatedverification}, while \autoref{chap:automatedsynthesis} is devoted to the experimentation, 
