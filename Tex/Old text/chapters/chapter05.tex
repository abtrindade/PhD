...
Only case study $7$ led to a \textit{time out} result, i.e., 
it was not solved within $240$ minutes. However, if it is remove 
...
if it is removed the time out from ESBMC with the SMT solver Boolector, 
