...
\centering
\caption{Unregulated standalone solar PV system with DC load. Source: \cite{Roy}.}
\label{fig:unregSPV}
\end{figure}
...
\centering
\caption{Regulated standalone solar PV system with DC load. Source: \cite{Roy}.}
\label{fig:regSPV1}
\end{figure}
...
\centering
\caption{Regulated standalone solar PV system with battery and DC load. Source: \cite{Roy}.}
\label{fig:regSPV2}
\end{figure}
...
\centering
\caption{Regulated standalone PV system with battery, AC load. Source: \cite{Roy}.}
\label{fig:regSPV3}
\end{figure}
