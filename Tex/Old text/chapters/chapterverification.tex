...
In the houses that use a $975$ W PV system (house $1$, house $2$, house $3$, and house $4$), ESBMC reached an error in any of the four houses and the execution time took less than $01$ s. Fig.~\ref{fig:esbmcverifhouse1} shows the output report of the tool for house $1$, with the FAIL identified. The author highlighted the result, which shows that the design flaw was found (SAT result or SUCCESS) within the bound $k$ of $100$, when a expected PV panels total power of $1,636.76$ W is expected and the sized system has only $975$ W. This flaw is related to Eq.~\eqref{eq:Pminpanel}.
