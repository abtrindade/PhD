...
based on intuitive, numerical and analytical methods were developed and evaluated \textcolor{red}{~\cite{Applasamy2011}}. 
...
\textcolor{red}{The NPC or life-cycle cost is the present value of all the costs over the project lifetime, minus the present value of all the revenues that it earns over the project lifetime. The net present worth is found by discounting all cash inflows and outflows}, 
including cost of installation, replacement and maintenance of the PV system, 
at an internal rate of return (IRR)~\cite{Park2004}.  IRR is used to evaluate the attractiveness of a project or investment.
