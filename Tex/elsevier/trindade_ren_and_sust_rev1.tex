...
%
%--------------------------------------------------
\section{Verification of the PV Project Sizing}
%--------------------------------------------------
...
Therefore this is a additional feature included at this paper. The sizing check will be performed, as proposed at the methodology, and the tool will indicate if there is an error of sizing before to perform the automated verification of the system. This stage ensures that the system meets the standard project steps related to the critical design month~\cite{Pinho}.
%
...
Related to the charge controller, initially it must meet the voltage requirement of the PV system, as described by ~\eqref{eq:vcvsystem}: 
\begin{equation}
\label{eq:vcvsystem}
V_{c} = V_{system}.
\end{equation}
...
\begin{figure}[h]
\includegraphics[width=0.80\textwidth]{system_original_blocks}
\centering
...
\begin{figure}[h]
\includegraphics[width=0.75\textwidth]{system_model_blocks}
\centering
