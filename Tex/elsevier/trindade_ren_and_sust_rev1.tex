...
Verification engine CBMC 5.11 and MiniSat 2.2.1 were used in the comparation~\cite{Kroening}\footnote{Command-line: \$ cbmc filename.c --unwind 100 --trace}.
...
\hline
\hline
House 1 &  \makecell{ $\leq$ 6 min \\(Out of Memory)} & \makecell{5m08s \\(SAT)} & \makecell{19m02s \\(SAT)} & \makecell{Time out \\ (UNKNOWN)}\\
\hline
House 2 &  \makecell{ $\leq$ 6 min \\(Out of Memory)} & \makecell{4m27s \\(SAT)} & \makecell{18m59s \\(SAT)} & \makecell{Time out \\ (UNKNOWN)}\\
\hline
House 3 &  \makecell{ $\leq$ 6 min \\(Out of Memory)} & \makecell{5m07s \\(SAT)} & \makecell{18m39s \\(SAT)} & \makecell{Time out \\ (UNKNOWN)}\\
\hline
House 4 &  \makecell{ $\leq$ 6 min \\(Out of Memory)} & \makecell{4m37s \\(SAT)} & \makecell{18m36s \\(SAT)} & \makecell{Time out \\ (UNKNOWN)}\\
\hline
House 5 &  \makecell{ $\leq$ 6 min \\(Out of Memory)} & \makecell{$\leq$ 1 sec \\(UNSAT Line 337)} & \makecell{$\leq$ 1 sec \\(UNSAT Line 337)} & \makecell{6 sec \\ (UNSAT line 337)}\\
\hline
\hline
\end{tabular}
\end{scriptsize}
