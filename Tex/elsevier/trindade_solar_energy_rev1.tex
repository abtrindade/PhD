...
\textcolor{red}{Note that the results presented here depend on the computer’s processor and memory, the version of each tool (CBMC, ESBMC, CPAchecker), the parameters passed by the command-line, and the algorithm to be solved. Additionally, any change from HOMER Pro to another tool can influence the measured time of the algorithms.}
