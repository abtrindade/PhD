...
\textcolor{red}{Those estimated load curves are converted as vectors with 24 positions, one to each house of the day (in Watts): 
...
Nevertheless, we have also identified \textcolor{red}{four} threats to the validity of our results that can further be assessed.
