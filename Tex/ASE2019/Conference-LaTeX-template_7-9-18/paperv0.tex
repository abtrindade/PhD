...
For future wore, we will perform additional experiments using other case studies and also compare the results of our approach with some off-the-shelf software that focuses on sizing and optimization. 
...
\textcolor{red}{We have to abbreviate our references. Take a look at https://ssvlab.github.io/lucasccordeiro/papers/icse2011.pdf, e.g., I've just put the conference acronym, remove conference place (New York), etc}
