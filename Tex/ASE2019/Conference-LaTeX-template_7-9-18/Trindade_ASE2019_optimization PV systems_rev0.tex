...
\author{\IEEEauthorblockN{1\textsuperscript{st} Alessandro Trindade}
\IEEEauthorblockA{\textit{Electricity Department} \\
\textit{Federal University of Amazonas}\\
Manaus, Brazil \\
alessandrotrindade@ufam.edu.br}
\and
\IEEEauthorblockN{2\textsuperscript{nd} Lucas Cordeiro}
...
The sizing check will be performed by the proposed tool, and this stage ensures that the system meets the standard project steps related to critical period solar energy method~\cite{Pinho}. 
%
...
\hline
\hline
Tool & \makecell{Demand = 501W \\ Peak = 501W \\ Energy=3900Wh/day} & \makecell{Demand = 915W \\ Peak = 980W \\ Energy=4880Wh/day}\\
\hline
CBMC 5.11 (MiniSat 2.2.1) & x1 & x2 \\
\hline
ESBMC 6.0.0 (Boolector 3.0.1) & x1 & x2 \\
\hline
UAutomizer 0.1.24 (Z3 4.8.3) & x1 & x2 \\
\hline
CPAchecker 1.8 (MathSAT 5.5.3) & x2 & x4 \\
\hline
\hline
\end{tabular}
\end{scriptsize}
