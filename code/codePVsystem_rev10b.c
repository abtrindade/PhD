...
#define Pmref 325
#define np 16.72
#define Insol 4.92 //(Wh/m2/day stalix.com/isolation.pdf.)
...
void pvmodel (int Gf, int AMBtemperaturef){
	...
	kb = 1.3806503*power(10,-23);  //Boltzmann constant in Joule
	q = 1.60217646*power(10,-19);  //absolute value of the electron's charge
...
int sizing_check(void){
	...
	NBtotal = Vsystem * Cbank / (Vbat*capacity);
