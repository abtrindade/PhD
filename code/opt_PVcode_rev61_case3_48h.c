/*
 ============================================================================
 Name        : opt_PVcode_rev5_improved database.c CASE 3 with 48h autonomy
 Author      : Alessandro Trindade
 Version     : rev5 - JUN 2019: 40 equipment, lowerbound defined by SW, better HintCost
...
// int SOClimit = 75, SOCabsorption = 95, SOCfull = 100, Vbat = 12, VAC = 127;
//CASE2 = CASE 3 (but autonomy is 12h in CASE 3)
...
// int SOClimit = 75, SOCabsorption = 95, SOCfull = 100, Vbat = 12, VAC = 127;
//CASE 7 
// int Phouse = 1800, Psurge = 2900, Econsumption = 14000; //autonomy 48h
