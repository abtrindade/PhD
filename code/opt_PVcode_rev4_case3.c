/*
 ============================================================================
 Name        : opt_PVcode_rev3_improved database.c CASE 3
 Author      : Alessandro Trindade
 Version     : rev4 - May 2019
...
float PanelData[10][13] = {{1.94432, 0.1620, 72, 45, 0.053, -0.31, 9.18, 45.1, 315, 8.16, 36.6, 33.4, 0.26840},
			  ...
			  {1.94035, 0.1855, 72, 45, 0.039, -0.307, 9.73, 47.60, 360, 9.33, 38.59, 34.96, 0.23724},
			  {1.00640, 0.1515, 36, 45, 0.033, -0.39, 8.81, 22.30, 150, 8.20, 18.30, 14.40, 0.09475},
			  {0.99960, 0.1500, 36, 46, 0.060, -0.37, 8.61, 22.90, 150, 8.12, 18.50, 14.61, 0.10850}};
//
...
float BatteryData [10][6] = {{0.85, 12, 80, 14.4, 13.8, 0.13100},
			    {0.85, 12, 105, 14.4, 13.8, 0.15000},
			    {0.85, 12, 150, 14.4, 13.8, 0.32475},
			    {0.85, 12, 175, 14.4, 13.8, 0.29975},
                            {0.85, 12, 220, 14.4, 13.8, 0.37475},
			    {0.85, 12, 60, 14.4, 13.8, 0.11475},
			    {0.85, 12, 80, 14.4, 13.2, 0.13800},
			    {0.85, 12, 150, 14.4, 13.2, 0.27500},
			    {0.85, 12, 170, 14.4, 13.2, 0.29901},
			    {0.85, 12, 220, 14.4, 13.2, 0.33073}};
...
float ControllerData [10][6] = {{0.98, 35, 24, 13, 145, 0.29495},
			       {0.98, 15, 24, 13, 75, 0.08840},
			       {0.98, 15, 24, 13, 100, 0.13770},
                               {0.98, 50, 24, 13, 100, 0.29495},
			       {0.98, 20, 24, 13, 100, 0.13225},
			       {0.98, 30, 24, 13, 100, 0.16100},
			       {0.98, 40, 24, 13, 100, 0.18475},
			       {0.97, 20, 24, 13, 100, 0.21725},
			       {0.97, 30, 24, 13, 100, 0.29725},
			       {0.96, 60, 60, 13, 140, 1.07250}};
...
float InverterData [10][6] =   {{0.93, 48, 110, 700, 1600, 0.400},
			       {0.93, 48, 110, 1200, 2400, 0.750},
			       {0.93, 24, 120, 1200, 2400, 0.450},
			       {0.91, 24, 120, 280, 750, 0.14975},
			       {0.91, 24, 120, 400, 1000, 0.18725},
			       {0.93, 12, 220, 600, 1350, 0.34225},
			       {0.93, 24, 120, 800, 1200, 0.500},
			       {0.90, 12, 120, 900, 2000, 0.64975},
			       {0.82, 12, 120, 1000, 2000, 1.12225},
			       {0.90, 24, 125, 1800, 2900, 1.66975}};
